...
def visualize():
    ...
    data_df01 = generate_data(m=m, n=n, activation=nn.ReLU(), size=size)
    data_df02 = generate_data(m=m, n=n, activation=nn.Sigmoid(), size=size)
    data_df03 = generate_data(m=m, n=n, activation=nn.Tanh(), size=size)
    data_df04 = generate_data(m=m, n=n, activation=nn.LeakyReLU(), size=size)
    ...
    data_df11 = generate_data(m=m, n=n, activation=nn.ReLU(), size=size)
    data_df12 = generate_data(m=m, n=n, activation=nn.Sigmoid(), size=size)
    data_df13 = generate_data(m=m, n=n, activation=nn.Tanh(), size=size)
    data_df14 = generate_data(m=m, n=n, activation=nn.LeakyReLU(), size=size)
